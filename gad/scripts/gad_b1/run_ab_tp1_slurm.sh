...
#SBATCH --job-name=gad-ab-tp1
#SBATCH --output=/home/saadlahrichi/gad_run/logs/ab-tp1-%j.out
...
echo "===== 4/4: launch 3-step A/B smoke (variant B: TP=1, no checkpoint) ====="
...
grep -aoE "timing_s/step:[0-9.]+|timing_s/gen:[0-9.]+|perf/throughput:[0-9.]+" "${SLURM_JOB_ID:+/home/saadlahrichi/gad_run/logs/ab-tp1-${SLURM_JOB_ID}.out}" 2>/dev/null | tail -12 || true
echo "DONE"
