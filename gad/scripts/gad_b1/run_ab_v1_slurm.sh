...
#SBATCH --output=/home/saadlahrichi/gad_run/logs/ab-v1-%j.out
...
grep -aoE "timing_s/step:[0-9.]+|timing_s/gen:[0-9.]+|perf/throughput:[0-9.]+" "${SLURM_JOB_ID:+/home/saadlahrichi/gad_run/logs/ab-v1-${SLURM_JOB_ID}.out}" 2>/dev/null | tail -12 || true
echo "DONE"
