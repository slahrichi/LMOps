...
| SeqKD baseline | teacher-forcing SFT of the base 7B on GPT-5 responses (branch `seqkd`): lr **5e-6**, **4 epochs** (984 steps), bs/mini 256, maxlen 2048/1536, no discriminator/GRPO. Paper-faithful vs `gpt5-chat-filtered-7b-seqkd-lr5e-6.sh`. |
