...
CKPT_ROOT=${CKPT_ROOT:-$WORKDIR/ckpts}   # OUTPUT root; override to /checkpoints/saadlahrichi/gad_run/ckpts (Lustre). Warmup is still READ from $WORKDIR/ckpts/$WARMUP_EXP.
CKPT=$CKPT_ROOT/$EXP
